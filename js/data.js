...
const REAL_SEASON_STATS = {
    'LG': {
        ...
        // 홍창기: 2025 부상시즌(51G) → 커리어 평균 기반 보정 (2021-2024 평균 .320, wRC+ 149, WAR 5.2)
        '홍창기': { pos:'RF', AVG:.321, OBP:.393, SLG:.471, OPS:.864, 'wRC+':149.0, WAR:5.23, oWAR:4.80, dWAR:0.43, H:155, '2B':25, '3B':2, HR:14, RBI:65, R:80, SB:10, CS:3, BB:65, SO:80, G:130, PA:550, AB:480, IsoP:.150, salary:5.2, defRAA:0.50, rangeRAA:-0.50, errRAA:0.20, armRAA:0.80 },
